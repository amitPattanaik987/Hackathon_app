...
const PaymentFailedPage = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-white to-red-900">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/home" className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">
            Retry Payment
          </Link>
